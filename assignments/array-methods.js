...
let allCaps = [];
runners.map(element => { let noCaps = element.first_name; allCaps.push(noCaps.toUpperCase())})
console.log(allCaps); 
...
// Problem 1
runnerEmails = [];
runners.forEach(element => {runnerEmails.push(element.email)})
console.log(runnerEmails)
// Problem 2
runnerEmailDonation = [];
runners.forEach(element => {runnerEmailDonation.push(element.email, element.donation)})
console.log(runnerEmailDonation)
// Problem 3
let highestDonation = [];
runners.forEach(element => {highestDonation.push(element.donation)})
highestDonation.sort((a,b)=>a-b)
console.log("The Highest Donation was $", highestDonation.slice(-1)[0])